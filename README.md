...
本仓库 fork 自 [Ackites/Nrfr](https://github.com/Ackites/Nrfr)，基于 Apache-2.0 许可证保留原项目授权和归属说明。本 fork 主要修改了 Android 16 兼容、Shizuku 调用链路、双 APK helper 安装流程、当前 SIM 配置展示和选择框性能等内容。
